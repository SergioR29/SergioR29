# Sobre mí 👨‍💻
Desarrollador de software especializado en el desarrollo de aplicaciones de escritorio con Python y en el de aplicaciones para móviles Android con Java. Enfocado en crear soluciones eficientes y mantenibles, integrando herramientas de IA para agilizar el desarrollo y mejorar la productividad.  
...
Esta aplicación es ideal para turistas y residentes de la provincia de Guadalajara (Castilla-La Mancha, España), Se ha seguido la metodología de desarrollo **RUP** a la hora de trabajar en todo el proyecto.  
